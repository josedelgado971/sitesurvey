...
<body>
    <header>
        <div class="logo">Agregar Caballos</div>
        <nav>
            <a href="../categorias/usercaballos.php" role="button">Volver</a>
        </nav>
    </header>

    <div class="addproduct" style="text-align: center;">
        <form method="POST" action="../add/useradd_caballos.php">
