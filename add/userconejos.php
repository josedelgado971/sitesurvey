...
<body>
    <header>
        <div class="logo">Agregar Conejos</div>
        <nav>
            <a href="../categorias/userconejos.php" role="button">Volver</a>
        </nav>
    </header>

    <div class="addproduct" style="text-align: center;">
        <form method="POST" action="../add/useradd_conejos.php">
