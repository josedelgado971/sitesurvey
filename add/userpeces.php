...
<body>
    <header>
        <div class="logo">Agregar Peces</div>
        <nav>
            <a href="../categorias/userpeces.php" role="button">Volver</a>
        </nav>
    </header>

    <div class="addproduct" style="text-align: center;">
        <form method="POST" action="../add/useradd_peces.php">
