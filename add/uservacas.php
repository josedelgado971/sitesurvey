...
<body>
    <header>
        <div class="logo">Agregar vacas</div>
        <nav>
            <a href="../categorias/uservacas.php" role="button">Volver</a>
        </nav>
    </header>

    <div class="addproduct" style="text-align: center;">
        <form method="POST" action="../add/useradd_vacas.php">
