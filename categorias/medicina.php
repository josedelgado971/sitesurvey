...
<body>
    ...
    <header>
        <nav>
            <a href="../add/medicinas.php" role="button">Agregar</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="modify"><a name="edit" id="" class="bfix"
                            href="../edit/medicinas.php?id=<?php echo $row['id'] ?>&nombre=<?php echo $row['nombre'] ?>&cantidad=<?php echo $row['cantidad']; ?> "
                            role="button">
                            Editar
                        </a></td>
                    <td class="delete"><a name="id" id="" class="bdelete"
                            href="../delete/medicinas.php?id=<?php echo $row['id'] ?>" role="button">
                            Eliminar
                        </a></td>
                </tr>
                <?php
