...
<body>
    ...
    <header>
        <nav>
            <a href="../add/peces.php" role="button">Agregar</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="modify"><a name="edit" id="" class="bfix"
                            href="../edit/peces.php?id=<?php echo $row['id'] ?>&ident=<?php echo $row['ident'] ?>&ubicacion=<?php echo $row['alojamiento'] ?>&alimento=<?php echo $row['alimento'] ?>&medicina=<?php echo $row['cuidados'] ?>&otros=<?php echo $row['otros']; ?> "
                            role="button">
                            Editar
                        </a></td>
                    <td class="delete"><a name="id" id="" class="bdelete"
                            href="../delete/peces.php?id=<?php echo $row['id'] ?>" role="button">
                            Eliminar
                        </a></td>
                </tr>
                <?php
