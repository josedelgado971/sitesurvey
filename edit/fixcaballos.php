<?php
    ...
    if($_POST['ident'] != null && $_POST['alojamiento'] != null && $_POST['alimento'] != null && $_POST['cuidados'] != null && $_POST['otros'] != null){
        //$sql = "UPDATE caballos SET proname = '" . trim($_POST['name']) . "' ,amount = '" . trim($_POST['value']) . "' WHERE id = '" . $_POST['id'] . "'";
        $sql = "UPDATE caballos SET ident = '" . trim($_POST['ident']) . "' ,alojamiento = '" . trim($_POST['alojamiento']) . "' ,alimento = '" . trim($_POST['alimento']) . "' ,cuidados = '" . trim($_POST['cuidados']) . "' ,otros = '" . trim($_POST['otros']) . "' WHERE id = '" . $_POST['id'] . "'";
        if($conn->query($sql)){
