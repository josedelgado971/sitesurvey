...
<body>
    <header>
        <div class="logo">Editar Cerdos</div>
        <nav>
    ...
    <div class="fixproduct" style="text-align: center;">
        <form method="POST" action="../edit/fixcerdos.php">
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" class="form-control" name="alimento" value="<?php echo isset($_GET['alimento']) ? $_GET['alimento'] : ''; ?>" maxlength="1000"
                    required>
            </div>
            <div class="form-group">
