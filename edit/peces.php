...
$sql_fetch_todos = "SELECT * FROM peces ORDER BY id ASC";
...
<body>
    <header>
        <div class="logo">Editar Peces</div>
        <nav>
            <a href="../categorias/peces.php" role="button">Volver</a>
        </nav>
    </header>

    <div class="fixproduct" style="text-align: center;">
        <form method="POST" action="../edit/fixpeces.php">
            ...
            <div class="form-group">
                ...
                <br>
                <input type="text" class="form-control" name="alimento" value="<?php echo isset($_GET['alimento']) ? $_GET['alimento'] : ''; ?>"
                    required>
            </div>
            <div class="form-group">
